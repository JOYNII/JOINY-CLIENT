...
const themes = [
  { name: "기본", value: "default", description: "가장 기본적인 초대장입니다." },
  { name: "크리스마스", value: "christmas", description: "연말 파티를 위한 테마입니다." },
  { name: "동창회", value: "reunion", description: "오랜 친구들과의 모임을 위한 테마입니다." },
];

const ThemeSelectionModal: React.FC<ThemeSelectionModalProps> = ({ onClose }) => {
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50" onClick={onClose}>
      <div className="bg-white rounded-xl shadow-2xl p-8 m-4 max-w-lg w-full" onClick={(e) => e.stopPropagation()}>
